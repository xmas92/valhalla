...
private:
  ...
  copy_to(InlineKlassPayloadImpl<OtherOopOrHandle>& dst,
          bool dest_is_initialized);
  template <typename OtherOopOrHandle>
...
public:
  ...
  inline void copy_to_uninitialized(const FlatFieldInlineKlassPayload& dst);
  inline void
  ...
  inline void copy_to_uninitialized(const FlatArrayInlineKlassPayload& dst);
  inline void
